...
#
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/${GitUser}/ssh/main/accel.conf"
...
GitUser="FokusDotId"
#wget https://github.com/${GitUser}/
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/${GitUser}/ssh/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/${GitUser}/ssh/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
