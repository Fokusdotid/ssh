...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/ssh/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/${GitUser}/ssh/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
