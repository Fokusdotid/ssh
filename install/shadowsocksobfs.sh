...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addss.sh"
wget -O delss "https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/${GitUser}/ssh/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/${GitUser}/ssh/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
