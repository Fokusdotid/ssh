...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/${GitUser}/ssh/main/install/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/${GitUser}/ssh/main/install/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/${GitUser}/ssh/main/renewssr.sh && chmod +x /usr/bin/renewssr
