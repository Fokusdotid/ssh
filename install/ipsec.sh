...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/${GitUser}/ssh/main/tambah/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/${GitUser}/ssh/main/hapus/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/${GitUser}/ssh/main/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/${GitUser}/ssh/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/${GitUser}/ssh/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
